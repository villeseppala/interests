          ...
          div(id = "page-title",
              ...
              div(id = "controls-row",
                  ...
                  tags$a(id = "site-url-label", href = "https://villeseppala.github.io/interests", target = "_blank",
                         style = "flex:1;text-align:center;font-size:clamp(6px,0.83vw,15px);color:rgba(255,255,255,1);text-decoration:none;white-space:nowrap;overflow:hidden;letter-spacing:0.02em;",
