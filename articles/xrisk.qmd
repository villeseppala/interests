...
It runs entirely in your browser, so the first load takes a few seconds while the R runtime downloads. [Open the app full-screen in a new tab &#8599;](xrisk-app.html){target="_blank"}
